...
context "Stream Name" do
  context "Category" do
    stream_name = MessageStore::EventStore::StreamName.stream_name('someCategory')
  ...
  context "Category and ID" do
    stream_name = MessageStore::EventStore::StreamName.stream_name('someCategory', 'some_id')
  ...
  context "Category and Type" do
    stream_name = MessageStore::EventStore::StreamName.stream_name('someCategory', type: 'someType')
  ...
  context "Category and Types" do
    stream_name = MessageStore::EventStore::StreamName.stream_name('someCategory', types: ['someType', 'someOtherType'])
  ...
  context "Category, Type, and Types" do
    stream_name = MessageStore::EventStore::StreamName.stream_name('someCategory', type: 'someType', types: ['someOtherType', 'yetAnotherYet'])
  ...
  context "Category, Type and ID" do
    stream_name = MessageStore::EventStore::StreamName.stream_name('someCategory', 'some_id', type: 'someType')
